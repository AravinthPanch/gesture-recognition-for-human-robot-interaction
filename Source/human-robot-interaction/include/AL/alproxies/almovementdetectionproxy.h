...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// <summary>
      /// Gets the mode (2D/3D) used for the detection.
      /// </summary>
      /// <param name="arg1"> arg </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setDetectionMode(const std::string& arg1);
  ...
  public:
    ...
    /// <summary>
    /// Sets the mode (2D/3D) used for the detection.
    /// </summary>
    /// <param name="mode"> Mode to use. </param>
    std::string getDetectionMode();
    ...
    /// </summary>
    /// <param name="arg1"> arg </param>
    void setDetectionMode(const std::string& arg1);
