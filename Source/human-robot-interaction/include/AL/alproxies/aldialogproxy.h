...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// <summary>
      /// generate all the sentences that recognized by the input topics
      /// </summary>
      /// <param name="arg1"> arg </param>
      /// <param name="arg2"> arg </param>
      /// <param name="arg3"> arg </param>
      ...
      /// <param name="arg3"> arg </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setConcept(const std::string& arg1, const std::string& arg2, const std::vector<std::string>& arg3);
  ...
  public:
    ...
    /// <param name="arg2"> arg </param>
    /// <param name="arg3"> arg </param>
    void setConcept(const std::string& arg1, const std::string& arg2, const std::vector<std::string>& arg3);
