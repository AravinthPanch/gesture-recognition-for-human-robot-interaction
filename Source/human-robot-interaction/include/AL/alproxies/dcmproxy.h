...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setAlias(const std::string& commands, const int& arg2, const std::vector<float>& arg3);
      ...
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setAlias(const AL::ALValue& name);
  ...
  public:
    ...
    /// <param name="arg2"> arg </param>
    /// <param name="arg3"> arg </param>
    void setAlias(const std::string& commands, const int& arg2, const std::vector<float>& arg3);
    ...
    /// <param name="time"> time for the timed command </param>
    /// <param name="commands"> std::vector<float> with all commands </param>
    void setAlias(const AL::ALValue& name);
