...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// </summary>
      /// <param name="pTarget"> a predefined target to track.Could be "RedBall", "Face", "LandMark", "LandMarks", "People", "Sound" or "Compass". </param>
      ...
      /// </summary>
      /// <param name="pTarget"> a predefined target to remove.Could be "RedBall", "Face", "LandMark", "LandMarks", "People", "Sound" or "Compass". </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      ...
      /// </summary>
      /// <param name="pTarget"> a predefined target list to remove.Could be "RedBall", "Face", "LandMark", "LandMarks", "People", "Sound" or "Compass". </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      ...
      /// </summary>
      /// <param name="pTarget"> a predefined target name.Could be "RedBall", "Face", "LandMark", "LandMarks", "People", "Sound" or "Compass". </param>
      ...
      /// <summary>
      /// Set the tracker in the predefined mode.Could be "Head", "WholeBody", "Move" or "MoveSafely".
      /// </summary>
      ...
      /// <summary>
      /// Set the robot position relative to target in Move and MoveSafely modes.
      /// </summary>
  ...
  public:
    ...
    /// <summary>
    /// Get the robot position relative to target in Move and MoveSafely modes.
    /// </summary>
