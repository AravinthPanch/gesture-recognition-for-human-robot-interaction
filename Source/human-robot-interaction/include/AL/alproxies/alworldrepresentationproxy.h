...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// <summary>
      /// Set the look of objects from the database.
      /// </summary>
      /// <param name="arg1"> arg </param>
      /// <param name="arg2"> arg </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setObjectsLook(const std::string& arg1, const AL::ALValue& arg2);

      /// <summary>
      /// Start the automatic display.
      /// </summary>
      /// <param name="arg1"> arg </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int startDisplaying(const int& arg1);
  ...
  public:
    ...
    /// <param name="arg1"> arg </param>
    /// <param name="arg2"> arg </param>
    void setObjectsLook(const std::string& arg1, const AL::ALValue& arg2);

    /// <summary>
    /// Start the automatic display.
    /// </summary>
    /// <param name="arg1"> arg </param>
    void startDisplaying(const int& arg1);
