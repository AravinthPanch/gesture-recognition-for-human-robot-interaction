...
namespace AL
{
  ...
  namespace detail {
    ...
    public:
      ...
      /// </summary>
      /// <param name="state"> The possible states of AutonomousLife are: interactive, solitary, reflex, disabled </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
  ...
  public:
    ...
    AL::ALValue getActivityStatistics();
    ...
    /// <summary>
    /// Get the time in seconds since Autonomous Life started.
    /// </summary>
    /// <returns> The time in seconds since Autonomous Life started. </returns>
    int getLifeTime();
    ...
    /// </summary>
    /// <returns> Can be: solitary, interactive, reflex, disabled </returns>
    std::string getState();
