\chapter{Background} \label{ch:background} Computer vision is a broad field that includes methods for acquiring, processing, analyzing and understanding images and, in general, high-dimensional data from the real world in order to produce numerical or symbolic information in the forms of decisions \cite{8}.
...
\input{chapter/content/background/nao} \input{chapter/content/background/gesture}
